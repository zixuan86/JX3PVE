...
$lang = array (
  ...
  'attachsize' => '文件大小',
  'attachprice' => '需要米币',
  'status_insufficient' => '抱歉，您的 {$_G[setting][extcredits][$_G[setting][creditstransextra][1]][title]} 不足，无法下载，成为<a href="./vip" class="tobevip">VIP会员</a>全站资源免费下载，无需回复即可查看隐藏内容。',
  'post_hide' => '本帖隐藏的内容，成为<a href="./vip" class="tobevip">VIP会员</a>全站资源免费下载，无需回复即可查看隐藏内容。',
  'post_hide_credits' => '以下内容需要积分高于 $creditsrequire 才可浏览，成为<a href="./vip" class="tobevip">VIP会员</a>全站资源免费下载，无需回复即可查看隐藏内容。',
  'post_hide_credits_hidden' => '，本帖隐藏的内容需要积分高于 $creditsrequire 才可浏览，您当前积分为 {$_G[member][credits]}，，成为<a href="./vip" class="tobevip">VIP会员</a>全站资源免费下载，无需回复即可查看隐藏内容。',
  'post_hide_reply_hidden' => '，如果您要查看本帖隐藏内容请<a href="forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]" onclick="showWindow(\'reply\', this.href)">回复</a>，成为<a href="./vip" class="tobevip">VIP会员</a>全站资源免费下载，无需回复即可查看隐藏内容。',
  ...
  'attach_nopermission' => '您所在的用户组无法下载或查看附件，成为<a href="./vip" class="tobevip">VIP会员</a>全站资源免费下载，无需回复即可查看隐藏内容。',
